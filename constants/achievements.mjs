...
export const achievements = [
  ...
  },
  {
    id: 24,
    name: "拾えるものは拾っとこう",
    description: "累計で5個のあまやどんぐりを手に入れた。", // 10 -> 5
    reward: {},
  },
  {
    id: 25,
    name: "どんぐり拾いが日課に", //あまやどんぐりチケットの切り所 -> どんぐり拾いが日課に
    description: "累計で10個のあまやどんぐりを手に入れた。", // 5 -> 10
    reward: {},
  },
  {
    id: 26,
    name: "あまやどんぐり収集家",
    description: "累計で20個のあまやどんぐりを手に入れた。", // 50 -> 20
    reward: {},
  },
  {
    id: 27,
    name: "あまやどんぐりチケットの切り所", // 雨宿りに忠誠を誓う -> あまやどんぐりチケットの切り所
    description: "累計で30個のあまやどんぐりを手に入れた。", // 100 -> 30
    reward: {},
  },
  {
    id: 28,
  ...
  },
  {
    ...
    name: "☆正気の沙汰じゃぁありません",
    description:
      "【ゴールドトロフィー】実績を100以上取得した状態で実績一覧を見る",
  ...
  },
  {
    id: 123,
    name: "ニョボバンクがあって良かった",
    description: "チップボーナスが+300,000%に到達する",
    reward: {},
  },
  {
    id: 124,
    name: "ザ・ゴッドチップ",
    description: "チップボーナスが+777,777%に到達する",
    reward: {},
  },
  {
    id: 125,
  ...
  },
  {
    id: 139,
    name: "☆きっと全ては夢だった",
    description: "【ゴールドトロフィー】ピザ宇宙の終わりにたどり着く", //Eternity
    reward: {},
  },
  //ここから新規実装
  {
    id: 140,
    name: "質量兵器",
    description: "ニョボチップが+7,777,777%に達する",
    reward: {},
  },
  {
    id: 141,
  ...
  },
  {
    id: 143,
    name: "ニョボチップ銀河",
    description: "ニョボチップが+77,777,777%に達する",
    reward: {},
  },
  {
    id: 144,
    name: "ニョボシ・インフィニティ",
    description: "ニョボチップの消費量が1000億に到達する",
    reward: {},
  },
  {
    id: 145,
    name: "エターナル・ブレイクダウン",
    description: "Break Eternity", //エタニティを10回する
    reward: {},
  },
  {
    id: 146,
    name: "ニョボシ・エタニティ",
    description: "ニョボチップの消費量が1兆に到達…できるの？",
    reward: {},
  },
  {
    id: 147,
    name: "本末転倒",
    description: "ニョワミヤ数がe100,000に到達する。",
    reward: {},
  },
  {
    id: 148,
  ...
  {
    id: 149,
    name: "★あなたは神谷マリアを降参させた",
    description:
      "【プラチナトロフィー】149個目までの全てのトロフィーを手に入れる",
    reward: {},
  },
...
export const hidden_achievements = [
  ...
  },
  {
    id: 12,
    name: "雨宿りに忠誠を誓う",
    hint: "あれじゃあ物足りないと思いましたか？",
    description: "累計で50個のあまやどんぐりを手に入れる。",
  },
  {
    id: 13,
    name: "雨宿りに魂を売り渡す",

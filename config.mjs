...
export default {
  ...
  idle: {
    ...
    infinityChallenges: [ //IC1~8は自由、9は1~8クリアで出現、2以降は未実装
      ...
      //{ id: "IC5", name: "パッシブ光輝は禁止！禁止です！", description: "#4を取得できない", bonus: "未定" }, //#4強化にすると処理が多くておぼろろろ
      //{ id: "IC6", name: "ライバル現る！？", description: "ライバルに抜かれる事なく逃げ切れ！", bonus: "インフィニティ後、#1~#4がLv1から始まる" },//現実時間60秒ごとに0 -> 1 -> e1 -> e2…となるピザ屋に負けたらIC中断
      { id: "IC7", name: "貧乏くじは引きたくない", description: "アセンションがニョワ1匹から使えるが…", bonus: "アセンション倍率 + 0.025" },//  e40 * e1^n　-> 1 * e10^n
      { id: "IC8", name: "アドブロッカー", description: "アセンションができない", bonus: "アセンション倍率1.1倍" },//元は1.125 -> IC7,8合わせて1.265,

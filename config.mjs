...
export default {
  ...
  idle: {
    ...
    infinityChallenges: [ //IC1~8は自由、9は1~8クリアで出現、2以降は未実装
      ...
      //{ id: "IC5", name: "パッシブ光輝は禁止！禁止です！", description: "TPの獲得量が大きく減る", bonus: "TPが少しだけ増える" },
      //{ id: "IC6", name: "ライバル現る！？", description: "ライバルに抜かれる事なく逃げ切れ！", bonus: "未定" },//現実時間60秒ごとに0 -> 1 -> e1 -> e2…となるピザ屋に負けたらIC中断
      //{ id: "IC7", name: "貧乏くじは引きたくない", description: "アセンションの要求人口が大きく増える", bonus: "アセンション倍率 + 0.025" },//  e40 * e1^n　-> 1 * e10^n
      //{ id: "IC8", name: "アドブロッカー", description: "アセンション禁止", bonus: "アセンション倍率1.2倍" },//元は1.125 -> IC7,8合わせて1.38 ,
      //{ id: "IC9", name: "原点回帰", description: "オリーブ、小麦、パイナップルの効果が1になる", bonus: "IP2倍" },
    ],

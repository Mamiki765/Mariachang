  ...
  idle: {
    ...
    achievements: [
      ...
      },
      {
        ...
        name: "無限への三合目",
        description:
          "(未実装)ニョワミヤの数が2.9613e+92に到達(infinityの30%)",
        effect: "たどり着けるはずがない",
        reward: {},
      },
      {
        ...
        name: "あと半分",
        description:
          "(未実装)ニョワミヤの数が1.3407e+154に到達(infinityの50%)",
        effect: "たどり着けたらミスである",
        reward: {},
      },//未実装といいつつ処理は追加済みだけど
      {
        ...
        name: "ＴＨＥ　ＥＮＤ　？",
        description:
          "(未実装)ピザ工場の終わりを見る",//infinityに到達し、エンディングを見る。

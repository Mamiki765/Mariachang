...
| IC5 | パッシブ光輝は禁止！禁止です！ | #4取得不可 | SP+4(Infinity時#1~4がLv1から始まる) |
| IC6 | ライバル現る！？ | 実時間60秒ごとに毎分人口e1ずつ増えるニョーワピザが出現。起動時に負けるとInfinity Reset | 未定 |
| IC7 | 貧乏くじは引きたくない | アセンション要求人口が e40 * e1^n　-> 1 * e10^nに | アセンション倍率 +0.025 |
| IC8 | アドブロッカー | アセンション禁止 | アセンション倍率 + 0.025 | 
| IC9 | 原点回帰 | オリーブ、小麦改良、パイナップル使用不可 | IP2倍 |

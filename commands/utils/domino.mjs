...
*/       
        ...
        response += `-# ${index + 1}位: ${player} (${count}回)\n`;
        }); 
...
//        response += "君も「ドミノ」と発言してレッツドミノ！1d100代わりにもどうぞ";
      ...
      // 指定したインデックスから10個取得
        ...
        for (let i = startIndex; i < endIndex; i++) {
          response += `-# 第${i + 1}回:${history.totals[i]}枚 ${history.players[i]}人 崩した人:${history.losers[i]}\n`;
        }
      }

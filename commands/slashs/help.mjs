    ...
    slash1: {
      ...
      commands: [
        ...
        },
        {
          name: "/ロスアカシナリオ一覧",
          description:
            "ロスト・アーカディアの予約・参加可能なシナリオの一覧を出します",
          usage:
            "数時間に1回更新します、また新規シナリオはロスアカチャンネルに通知してます",
        },
        {
          name: "/ドミノ履歴",
        ...
        {
          name: "/スタンプ",
          description: "枠が足りない時に自作あるいは納品物のスタンプを置いて使うことができます",
          usage: "公開で保存すると全員が使えますが、ロスアカなら事前のライセンス取得を推奨します。非公開はライセンス不要です",
        },
      ],
    },
    slash2: {
